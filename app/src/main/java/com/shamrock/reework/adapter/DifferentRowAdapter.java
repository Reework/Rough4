...
public class DifferentRowAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public DifferentRowAdapter(MasterFoodFragmentAllMeals context, List<TodaysMeal> list, List<TodaysMealData.Datum> data) {
        this.mList = list;
            ...
            switch (object.getMeal_type()) {
                case CITY_TYPE:
                    try {
                        ...
                        if(object.getMeal_type_name().equals("Post Wakeup")){
                            ((HeaderViewHolder) holder).mTitle.setText("  Post wakeup " );

                        }
                        else  if(object.getMeal_type_name().equals("Mid-Morning")){
                            ((HeaderViewHolder) holder).mTitle.setText("  Mid-morning ");
                        }
                        else  if(object.getMeal_type_name().equals("Beverages & Snacks")){
                            ((HeaderViewHolder) holder).mTitle.setText("  Beverages & snacks ");
                        }
                        else  if(object.getMeal_type_name().equals("Pre-Dinner")){
                            ((HeaderViewHolder) holder).mTitle.setText("  Pre-dinner " );
                        }

                        else  if(object.getMeal_type_name().equals("1 Hour After Dinner")){
                            ((HeaderViewHolder) holder).mTitle.setText("  1 Hour after dinner ");
                        }
                        else  if(object.getMeal_type_name().equals("Before sleep")){
                            ((HeaderViewHolder) holder).mTitle.setText("  Before sleep ");
                        }
                        else  if(object.getMeal_type_name().equals("Combo (Breakfast+Lunch etc.)")){
                            ((HeaderViewHolder) holder).mTitle.setText("  " + object.getMeal_type_name());
                        }
                        else  if(object.getMeal_type_name().equals("Pre-Workout")){
                            ((HeaderViewHolder) holder).mTitle.setText("  Pre-workout ");
                        }
                        else  if(object.getMeal_type_name().equals("Post-Workout")){
                            ((HeaderViewHolder) holder).mTitle.setText("  Post-Workout ");
                        }
                        ...
                        if (min < max) {
                            ...
                            ((HeaderViewHolder) holder).mCalMin.setText(new DecimalFormat("##.#").format((Double.parseDouble(object.getMeal_cal_min()))));
...
//                            ((HeaderViewHolder) holder).mCalMin.setText(String.valueOf(object.getMeal_cal_max()));
                            ((HeaderViewHolder) holder).mCalMin.setText(new DecimalFormat("##.#").format(((object.getMeal_cal_max()))));
...
//                        intaktimes="("+object.getIntakeTime()+")";
                    ...
                    try {
                        ...
                        if (mList.get(position).getRecipeImagePath()!=null){
                            Glide.with(context)
                                    ...
                                    .into(((DifferentRowAdapter.RowViewHolder) holder).mImage);
                        }
                    ...
                    ((RowViewHolder) holder).mCalories.setText(new DecimalFormat("##.#").format((Double.parseDouble(object.getMeal_calory()))));
