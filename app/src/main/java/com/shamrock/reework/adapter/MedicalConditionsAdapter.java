...
public class MedicalConditionsAdapter extends RecyclerView.Adapter<MedicalConditionsAdapter.MyHolder> {

    Context context;
    ArrayList<MedicalConditionData> cityList;
    MedicalConditionListener listener;
    private boolean isFirstTime = false;
    int selectedPosition = -1;

    public interface MedicalConditionListener {
        public void GetmedicalCondition(ArrayList<MedicalConditionData> medicalcondition);
    }

    public MedicalConditionsAdapter(Context context, ArrayList<MedicalConditionData> cityList, MedicalConditionListener listener) {
    ...
    public class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            listener.GetmedicalCondition(cityList);
        }
    }

    @NonNull
    @Override
    public MedicalConditionsAdapter.MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final MedicalConditionsAdapter.MyHolder myHolder, final int i) {
...
//            }
        ...
        if (isFirstTime){
            ...
            if (model.isSelect()) {
//            if(i!=0&&!model.getMedicalconditionName().equals("None")) {
...
//                if (!model.getMedicalconditionName().equals("None")) {
//
//                    myHolder.rel_medicalcondition.setBackground(context.getResources().getDrawable(R.drawable.bg_done));
//                    myHolder.rel_medicalcondition.setPadding(15, 15, 15, 15);
//
