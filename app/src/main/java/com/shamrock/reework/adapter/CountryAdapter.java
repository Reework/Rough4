...
public class CountryAdapter extends RecyclerView.Adapter<CountryAdapter.MyHolder>
{
    ...
    public CountryAdapter(Context context, ArrayList<Country> countryList, CountryListener listener)
    {
    ...
    @NonNull
    @Override
    public CountryAdapter.MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
    ...
    @Override
    public void onBindViewHolder(@NonNull CountryAdapter.MyHolder myHolder, int i)
    {
        if (!TextUtils.isEmpty(countryList.get(i).getCountryName()))
            myHolder.tvName.setText(countryList.get(i).getCountryName());
    }
