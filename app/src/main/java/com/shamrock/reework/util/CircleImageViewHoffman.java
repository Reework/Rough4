...
public class CircleImageViewHoffman extends AppCompatImageView {
    ...
    public CircleImageViewHoffman(Context context) {
        super(context);

        init();
    }

    public CircleImageViewHoffman(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleImageViewHoffman(Context context, AttributeSet attrs, int defStyle) {
