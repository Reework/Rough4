...
public class FoodTripResponse implements Serializable
{
    @SerializedName("Code")
    @Expose
    ...
    @SerializedName("Data")
    @Expose
    private ArrayList<FoodStripData> data = null;
    ...
    public ArrayList<FoodStripData> getData() {
        return data;
    }

    public void setData(ArrayList<FoodStripData> data) {
        this.data = data;
    }

    public class FoodStripData implements Serializable
    {
