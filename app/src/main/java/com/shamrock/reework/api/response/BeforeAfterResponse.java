...
public class BeforeAfterResponse
{
    ...
    @SerializedName("Data")
    @Expose
    private ArrayList<BeforeAfterDataResponse> data = null;
    ...
    public ArrayList<BeforeAfterDataResponse> getData() {
        return data;
    }

    public void setData(ArrayList<BeforeAfterDataResponse> data) {
        this.data = data;
    }


    public static class BeforeAfterDataResponse
    {
