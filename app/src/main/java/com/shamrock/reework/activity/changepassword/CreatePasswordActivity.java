...
//        tvTitle.setTypeface(font);
        ...
        sessionManager = new SessionManager(CreatePasswordActivity.this);
        ...
        txt_get_otp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (edt_mobile.getText().toString().isEmpty()){
                    Toast.makeText(CreatePasswordActivity.this, "Please enter  mobile number", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (edt_mobile.getText().toString().length()<10){
                    Toast.makeText(CreatePasswordActivity.this, "Please enter valid mobile number", Toast.LENGTH_SHORT).show();
               return;
                }
        ...
        btn_update_password.setText("Set Password");
        ...
        btn_update_password.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (edt_otp.getText().toString().isEmpty()){
                    Toast.makeText(CreatePasswordActivity.this, "Please enter otp", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if(!isValidPassword(edt_new_pass.getText().toString())){
                    Toast.makeText(CreatePasswordActivity.this, "Password is not valid,should contain atleast 8 characters,one digit,one lower case letter,one special character", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (edt_new_pass_confirm.getText().toString().trim().isEmpty()){
                    Toast.makeText(CreatePasswordActivity.this, "Please enter confirm password", Toast.LENGTH_SHORT).show();
                    return;
                }

                if(!edt_new_pass.getText().toString().trim().equalsIgnoreCase(edt_new_pass_confirm.getText().toString().trim())){
                    Toast.makeText(CreatePasswordActivity.this, "Password and Confirm password should be same", Toast.LENGTH_SHORT).show();
                    return;
...
//        "$";
    ...
    {
        utils.showProgressbar(CreatePasswordActivity.this);
            ...
            public void onResponse(Call<AuthenticationResponse> call, Response<AuthenticationResponse> response)
            {
                ...
                if (response.code() == Client.RESPONSE_CODE_OK)
                {
                    ...
                    if (listResponse != null && listResponse.getCode().equalsIgnoreCase("1"))
                    {
                        ...
                        Toast.makeText(CreatePasswordActivity.this,listResponse.getMessage(), Toast.LENGTH_LONG).show();
