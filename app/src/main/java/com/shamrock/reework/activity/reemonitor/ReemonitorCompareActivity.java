...
public class ReemonitorCompareActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
...
//        tvTitle.setTypeface(font);
        imgLeft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ReemonitorCompareActivity.this, NewHealthMonitoringActivity.class);
        ...
        context = ReemonitorCompareActivity.this;
        ...
        submitFromDate = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date());
        submitToDate = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date());
        sessionManager = new SessionManager(ReemonitorCompareActivity.this);
        userID = sessionManager.getIntValue(SessionManager.KEY_USER_ID);
...
//        txt_weight_date_to = findViewById(R.id.txt_weight_date_to);txt_weight_date_to
    ...
    private void showNewgetSleephistroy() {
        ...
        final Dialog dialog = new Dialog(ReemonitorCompareActivity.this);
        ...
        btn_submit_sleep_hours.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Utils.isNetworkAvailable(ReemonitorCompareActivity.this)) {
...
//                    getHistoryParameterData();
    ...
    private void showDatePickerDailog() {
        String strMindate[] = new SessionManager(ReemonitorCompareActivity.this).getStringValue("mindate").split("-");
        ...
        datepickerdialog = new DatePickerDialog(ReemonitorCompareActivity.this, AlertDialog.THEME_DEVICE_DEFAULT_LIGHT, ReemonitorCompareActivity.this, year, month, day);
    ...
    private void showDatePickerDailogentry() {
        ...
        datepickerdialog_entry = new DatePickerDialog(ReemonitorCompareActivity.this, AlertDialog.THEME_DEVICE_DEFAULT_LIGHT, ReemonitorCompareActivity.this, year, month, day);
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.code() == Client.RESPONSE_CODE_OK) {
                    ...
                    try {
                        ...
                        PlannerAdapter clsReportCompareAdapter = new PlannerAdapter(ReemonitorCompareActivity.this, arylst_result, count);
...
//            txt_weight_date_select.setText(dummydate_from);
        ...
        if (StrDateOpen.equalsIgnoreCase("from")) {
            ...
            if (date1.after(date2)) {
                Toast.makeText(ReemonitorCompareActivity.this, "From date should be greater than To date", Toast.LENGTH_SHORT).show();
                return;
            }
            txt_sleep_date_from_dialog.setText(dummydate_from);
        ...
        if (StrDateOpen.equalsIgnoreCase("to")) {
            if (!dummydate_from.trim().isEmpty()) {
                ...
                if (date1.after(date2)) {
                    Toast.makeText(ReemonitorCompareActivity.this, "To date should be greater than From date", Toast.LENGTH_SHORT).show();
                    return;
                } else {
                    txt_sleep_date_to_dialog.setText(dummydate_to);
...
//                    getHistoryParameterData();
                ...
                Toast.makeText(ReemonitorCompareActivity.this, "Please select from date", Toast.LENGTH_SHORT).show();
            }
