...
public class UserFoodTripAdapterNew extends RecyclerView.Adapter<UserFoodTripAdapterNew.MyHolder>
{
    Context context;
//    ArrayList<UserFoodTripData> mFilterlist;
    List<TodaysMeal> mArrayList;
...
//    }
    ...
    public UserFoodTripAdapterNew(Context context, List<TodaysMeal> list) {
