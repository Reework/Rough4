...
public class MealTypeListDialog extends DialogFragment implements View.OnClickListener, MealTypeListAdapter.OnMealTypeSelect
{
    Context context;
    private Utils utils;
    ...
    ArrayList<MealTypeList> bundleList, languageList, languageListSearch;
    MealTypeListAdapter languageAdapter;
    GetMealtypeListener listener;

    private FoodUnitMasterData selectedLangaue = null;

    public MealTypeListDialog() {
    }
    ...
    public void getSelectedMealtype(MealTypeList cusineList) {
        ...
        listener.onSubmitMealtypeData(cusineList);
        this.dismiss();
    ...
    {
        void onSubmitMealtypeData(MealTypeList model);
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        if (getArguments() != null)
        {
            ...
            try
            {
                bundleList = (ArrayList<MealTypeList>) getArguments().getSerializable("CUSION_LIST");
                if (bundleList != null)
                {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        tvTitle.setText("Select Meal Type");
        ...
        languageAdapter = new MealTypeListAdapter(context, languageList, this);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener()
        {
            ...
            public boolean onQueryTextChange(String newText)
            {
                ...
                {
                    for (MealTypeList model:languageListSearch)
                    {
                        if (model.getMealType().toLowerCase().contains(newText.toLowerCase()))
                        {
