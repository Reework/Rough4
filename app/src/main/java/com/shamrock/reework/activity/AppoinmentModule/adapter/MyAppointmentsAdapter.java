...
public class MyAppointmentsAdapter extends RecyclerView.Adapter<MyAppointmentsAdapter.MyHolder>
{
    Context mContext;
    ...
    public MyAppointmentsAdapter(Context context, ArrayList<GetAllAppointmentResponse.AppointmentData> list,
                                 MyAppointmentListener listener)
    {
    ...
    {
        TextView tvTitle, tvDate, tvTime, tvEndTime,text_Appointmentstatus;
    ...
    {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_row_my_appointment, viewGroup, false);
...
//        String featureName = "Appointment with "+model.getFullname()+"";
