...
public class MyBloodReportAdapter extends RecyclerView.Adapter<MyBloodReportAdapter.MyHolder>
{
    ...
    public MyBloodReportAdapter(Context context, List<BCAResponce.Datum> list)
    {
        this.list = list;
        mContext = context;
...
//                       myHolder.tvTitle.setText(formatDates(model.getCreatedOn().substring(0,index))+" ("+model.getReportType()+")");
