...
public class WeightLatestVideoListAdapter extends RecyclerView.Adapter<WeightLatestVideoListAdapter.MyHolder>
{
    WeightActivitylatest context;
    ArrayList<ClsSpiritualData> list;
    OnWeightVideoListClick onHealthCatoryClick;
    int selectedPosition=-1;
    boolean isFirstTime=true;
    public WeightLatestVideoListAdapter(WeightActivitylatest context, ArrayList<ClsSpiritualData> list)
    {
        this.context = context;
        this.list = list;
        onHealthCatoryClick= (OnWeightVideoListClick) context;
    }
