...
public class OccassionAdapter extends RecyclerView.Adapter<OccassionAdapter.MyHolder>
{
    Context context;
    ArrayList<OccasionResponce.Datum> countryList;
    OccassionListener listener;

    public interface OccassionListener
    {
        public void GetOccassionPosition(int pos, OccasionResponce.Datum model);
    }


    public OccassionAdapter(Context context, ArrayList<OccasionResponce.Datum> countryList, OccassionListener listener)
    {
    ...
    public class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        {
            listener.GetOccassionPosition(getAdapterPosition(), countryList.get(getAdapterPosition()));
        }
    }
    ...
    public void onBindViewHolder(@NonNull MyHolder myHolder, int i)
    {
       // Log.e("Recipe",countryList.get(i).getRecipeName());
        if (!TextUtils.isEmpty(countryList.get(i).getOccasion()))
            myHolder.tvName.setText(countryList.get(i).getOccasion());
    }
