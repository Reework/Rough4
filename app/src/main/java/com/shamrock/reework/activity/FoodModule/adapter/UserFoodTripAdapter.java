...
public class UserFoodTripAdapter extends RecyclerView.Adapter<UserFoodTripAdapter.MyHolder> implements Filterable
{
    Context context;
    ...
    public UserFoodTripAdapter(Context context, ArrayList<UserFoodTripData> list, MasterFoodFragmentFoodTrip masterFoodFragmentFoodTrip)
    {
...
//                    listener.GetFootTripPosition(getAdapterPosition(), mFilterlist.get(getAdapterPosition()));
    ...
    public void showDetailsDailog(UserFoodTripData userFoodTripData){
        UserFoodTripDetailsDialogFragmet addFoodDialogFragmet=new UserFoodTripDetailsDialogFragmet(UserFoodTripAdapter.this);
