...
/**
 * A rating bar that allows customization to the ic_star_unfill element and more
 *
...
public class RatingBar extends View {
    ...
    protected static final int DEFAULT_FILLED_DRAWABLE = R.drawable.ic_star_fill;
    protected static final int DEFAULT_EMPTY_DRAWABLE = R.drawable.ic_star_unfill;
...
// patch up precision issue where this calculation results in a remainder that incorrectly subtracts off the rating.
    ...
    /**
     * @return Return ic_star_unfill count
     */
    public int getMax() {
    ...
    /**
     * Sets the stars margins, this is unconnected to starSize, it is a type of padding around each ic_star_unfill
     *
    ...
    /**
     * Sets the ic_star_unfill margins in PIXELS
     *
    ...
    /**
     * Sets the square box for ic_star_unfill size
     *
...
//Basically do not allow user to update this stuff is indicator only
     ...
     * @param xPerStar how many pixels (in the x direction) correspond to one ic_star_unfill
