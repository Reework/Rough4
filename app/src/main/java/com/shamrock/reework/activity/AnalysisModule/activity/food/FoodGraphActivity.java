...
public class FoodGraphActivity extends AppCompatActivity implements  AdapterView.OnItemSelectedListener, View.OnClickListener {
    Context context;
    Toolbar toolbar;
    Utils utils;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= FoodGraphActivity.this;
        ...
        labelMyProgress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!tempList.isEmpty()){
                    new GeneratePDF(tempList, FoodGraphActivity.this, spinner.getSelectedItem().toString()).execute();

                }else {
                    Toast.makeText(FoodGraphActivity.this, "No data available", Toast.LENGTH_SHORT).show();
        ...
        tvTitle.setText("Sleep  History Analysis");
        utils = new Utils();
...
//                        int index = aryCalories.get(i).getCreatedOn().indexOf("T");
                        ...
                        return aryCalories.get(i).getCreatedOn();
