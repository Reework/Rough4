...
public class WaterGeneratePDF extends AsyncTask<String, String, String> {
    private List<WaterData> transactionsDetails;
    private Context context;
    private ProgressDialog progressDialog;
    private String fromdate;
    private String todate;

    public WaterGeneratePDF(ArrayList<WaterData> transactionsDetails, Context mContext, String s) {
...
//                    Toast.makeText(context, "PDF downloaded at : " + result, Toast.LENGTH_SHORT).show();
    ...
    private String generatePDF() {
        ...
        try {
            ...
            String pdfName = "/Trend_water_consumption"  + ".pdf";
...
// Add item into Paragraph
            prHead.add("Trend Water Consumption \n\n\n");
...
// Create Table into Document with 1 Row
            float[] columnWidths = {2.4f, 1.4f,1.4f};
...
// Create New Cell into Table
            ...
            insertCell(table, "Scheduled(litres) ", Element.ALIGN_CENTER, 1, bfBold14);
            insertCell(table, "Actual(litres)", Element.ALIGN_CENTER, 1, bfBold14);
...
//                String datess=  formatDates(transactionsDetails.get(i).getHealthdate().substring(0,index));
                ...
                insertCell(table, String.valueOf(transactionsDetails.get(i).getScheduledWaterIntake()), Element.ALIGN_CENTER, 1, bf_normal);
                insertCell(table, String.valueOf(transactionsDetails.get(i).getActualWaterIntake()), Element.ALIGN_CENTER, 1, bf_normal);
            }
