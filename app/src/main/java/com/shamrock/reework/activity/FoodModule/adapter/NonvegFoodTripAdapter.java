...
public class NonvegFoodTripAdapter extends RecyclerView.Adapter<NonvegFoodTripAdapter.MyHolder> implements Filterable
{
    Context context;
    ...
    public NonvegFoodTripAdapter(Context context, ArrayList<FoodTripResponse.FoodStripData> list, FoodTripListener listener)
    {
