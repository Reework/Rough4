...
public class NewMyPlansActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener,TimePickerDialog.OnTimeSetListener,
...
//    ImageView img_user;
    ...
    private String itmeidscroll="";

    private TextView txt_action_score;
...
//    }
    ...
    private void setProfileImage()
    {
        sessionManager=new SessionManager(NewMyPlansActivity.this);
...
//                            dialogFragment = new AddMyPlanActivtyDialogFragment(NewMyPlansActivity.this);
...
//                            dialogFragment.show(fm, "edit_fragment");
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        context = NewMyPlansActivity.this;
        txt_main_remark=findViewById(R.id.txt_main_remark);
//        txt_action_score=findViewById(R.id.txt_action_score);
...
//        img_user=findViewById(R.id.img_user);
        ...
        findViewById(R.id.txt_all_glosary).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(NewMyPlansActivity.this,GlosaryListActivity.class);
...
//        txt_action_score=findViewById(R.id.txt_action_score);
//        txt_action_score.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Intent intent=new Intent(NewMyPlansActivity.this,ActionScoreActivity.class);
//                intent.putExtra("DataID",sendId);
//                startActivity(intent);
//            }
//        });
...
//            @Override
//            public void onClick(View v) {
//                Intent intent=new Intent(NewMyPlansActivity.this, DietProfileActivity.class);
...
//        });
    ...
    public void onBackPressed() {
        Intent intent = new Intent(NewMyPlansActivity.this, HomeActivity.class);
...
//        userIDuserID = sessionManager.getIntValue(SessionManager.KEY_USER_ID);
        ...
        txt_details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(NewMyPlansActivity.this,MyPlanDetailsActivity.class);
...
//                finish();
    ...
    private void showEntryDateAddDailog() {
        ...
        try {
            ...
            entry_datepickerdialog_history = new DatePickerDialog(NewMyPlansActivity.this, AlertDialog.THEME_DEVICE_DEFAULT_LIGHT, NewMyPlansActivity.this, year, month, day);
...
//        callMyPlanMasters();
        ...
        if (getIntent().getStringExtra("Backpage")!=null&&getIntent().getStringExtra("Backpage").equalsIgnoreCase("yes")){
...
//        spinnerList.add(0, data);
        ...
        passtitle=arylst_ClsPlanNames.get(0).getName();
        spinnerAdapter = new MyPlanNameMasterAdapter(context, arylst_ClsPlanNames);
        spinnerCategory.setAdapter(spinnerAdapter);
...
//                        swipeRefreshLayout.setRefreshing(false);
    ...
    public void setRecyclerView(ArrayList<MyPlanResponse.MyPlanData> tempDataList, int planId)
    {
        myPlansListAdapter = new MyPlansAdapter(context, tempDataList,
                NewMyPlansActivity.this, planId, NewMyPlansActivity.this);

        RecyclerView.LayoutManager manager = new LinearLayoutManager(NewMyPlansActivity.this);
...
//        btnSave.performClick();
    ...
    private void callTodaysPlanApi(int planID)
    {
        ...
        sessionManager.setStringValue("ActionScore",postDate);
                ...
                if (response.code() == Client.RESPONSE_CODE_OK)
                {
                    ...
                    if (listResponse != null && listResponse.getCode() == 1)
                    {
                        ...
                        if (aryltTodaysPlanData.getRemark()!=null){
                            txt_main_remark.setVisibility(View.GONE);
                        ...
                        NewClsTodaysPlansAdapter clsTodaysPlansAdapter=new NewClsTodaysPlansAdapter(NewMyPlansActivity.this,artylst_ReeworkerPlans);
                    ...
                    else
                    {
                        ...
                        ClsTodaysPlansAdapter clsTodaysPlansAdapter=new ClsTodaysPlansAdapter(NewMyPlansActivity.this,artylst_ReeworkerPlans);
...
//                Toast.makeText(context,"No data found ", Toast.LENGTH_SHORT).show();
    ...
    private void setActionScoreData(ArrayList<Score> score) {
        ...
        for (int i = 0; i <score.size() ; i++) {
            ...
            if (score.get(i).getPlanTypeId()==3){
    ...
    private void saveTodysMeal(PlanItems planItemsArrayList, String mealType, String planTime) {
        ...
        utils.showProgressbar(NewMyPlansActivity.this);
...
//            2021-12-12 07:42:26.138 26306-26390/com.shamrock D/OkHttp: {"Code":1,"Message":"Appointment scheduled successfully.","Data":{"IsPay":false,"PayLink":null}}
        ...
        call.enqueue(new Callback<GetMealType>()
        {
            ...
            public void onResponse(Call<GetMealType> call, Response<GetMealType> response)
            {
                ...
                if (response.code() == Client.RESPONSE_CODE_OK)
                {
                    ...
                    if (listResponse != null && listResponse.getCode() == 1)
                    {
                        Toast.makeText(NewMyPlansActivity.this, listResponse.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
...
//                            setData(tempList);
    ...
    public void addLifeStylePlan(String activityname,String activitytime,int durationInminu,int daytype,String planType){
        ...
        LifeStylePlanPost lifeStylePlanPost=new LifeStylePlanPost(planID,Integer.valueOf(new SessionManager(NewMyPlansActivity.this).getIntValue(SessionManager.KEY_USER_ID)),activityname,activitytime,durationInminu,"",dayType, planType);
...
//                finish();
        ...
        tvMealTime_food_plan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                timepickerdialog = new TimePickerDialog(context, NewMyPlansActivity.this,
