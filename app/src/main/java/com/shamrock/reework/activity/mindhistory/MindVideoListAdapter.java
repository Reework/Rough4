...
public class MindVideoListAdapter extends RecyclerView.Adapter<MindVideoListAdapter.MyHolder>
{
    MasterMindFragment context;
    ArrayList<ClsSpiritualData> list;
    OnMindVideoListClick onHealthCatoryClick;
    int selectedPosition=-1;
    boolean isFirstTime=true;
    public MindVideoListAdapter(MasterMindFragment context, ArrayList<ClsSpiritualData> list)
    {
        this.context = context;
        this.list = list;
        onHealthCatoryClick= (OnMindVideoListClick) context;
    }
