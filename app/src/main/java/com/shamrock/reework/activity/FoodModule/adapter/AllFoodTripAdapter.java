...
public class AllFoodTripAdapter extends RecyclerView.Adapter<AllFoodTripAdapter.MyHolder> implements Filterable
{
    Context context;
    ...
    public AllFoodTripAdapter(Context context, ArrayList<FoodTripResponse.FoodStripData> list, Context ctx)
    {
