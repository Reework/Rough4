...
public class ClsPlansDataAdapter extends RecyclerView.Adapter<ClsPlansDataAdapter.MyHolder>
{
    ...
    public ClsPlansDataAdapter(Context context,
...
//        this.planEditListener = planEditListener;
    ...
    public class MyHolder extends RecyclerView.ViewHolder
    {
        ...
        ImageView ivChecked,img_recipe,img_videoyoutube;
        ...
        public MyHolder(@NonNull View itemView)
        {
            ...
            img_videoyoutube=itemView.findViewById(R.id.img_videoyoutube);
            ...
            img_videoyoutube.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (dataList.get(getAdapterPosition()).getVideolink()!=null){
                        Intent intent=new Intent(context, ExoActivity.class);
                        intent.putExtra("VideoID",extractYTId(dataList.get(getAdapterPosition()).getVideolink()));
                    intent.putExtra("youtubelist_Name",youtubelist);
                        intent.putExtra("title",dataList.get(getAdapterPosition()).getItemName());
...
//                    context.startActivity(intent);
            ...
            txt_edit_food_plan.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    sessionManager.setStringValue("EditItmeAdd_Pos", String.valueOf(getAdapterPosition()));
...
//
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
        View view = LayoutInflater.from(viewGroup.getContext()).
                inflate(R.layout.row_plan_items, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull MyHolder myHolder, int i)
    {
        ...
        if (model.getVideolink()!=null&&!model.getVideolink().isEmpty()){
            youtubelist.add(extractYTId(model.getVideolink()));
            myHolder.img_videoyoutube.setAlpha((float) 1);

        }else {
            myHolder.img_videoyoutube.setAlpha((float) 0.5);
...
//            ((DifferentRowAdapter.RowViewHolder) holder).mQuantity.setText(""+strNewQty[0].toString());
        ...
        if (!sessionManager.getStringValue("EditItmeID").isEmpty()&&sessionManager.getStringValue("EditItmeAdd_Pos").equalsIgnoreCase(String.valueOf(i))){
            sessionManager.setStringValue("EditItmeID","");
            sessionManager.setStringValue("EditItmeAdd_Pos","");
            EditItmeAdd(i,myHolder.ivChecked);
        }
...
//
    ...
    public void showEditAddActivityDailog(final int adapterPosition, final boolean alternate, final ImageView ivChecked){
...
//
    ...
    public void showEditDeafaultDailog(final int adapterPosition, final ImageView ivChecked, final boolean alternate, String s){
...
//                                            .apply(options)
    ...
    public void EditItmeAdd(int getAdapterPositions, ImageView ivChecked){
        if (dataList.get(getAdapterPositions).getPlanMasterID().equals("6")||(dataList.get(getAdapterPositions).getPlanMasterID().equals("4"))){
            showmealDailog(getAdapterPositions,dataList.get(getAdapterPositions).isAlternate(),ivChecked);
        }else if (dataList.get(getAdapterPositions).getPlanMasterID().equals("5")) {
            showEditAddActivityDailog(getAdapterPositions,dataList.get(getAdapterPositions).isAlternate(),ivChecked);

        }else if (dataList.get(getAdapterPositions).getPlanMasterID().equals("1")){

            showEditDeafaultDailog(getAdapterPositions,ivChecked,dataList.get(getAdapterPositions).isAlternate(),"Nutrition Plan");


        }else if (dataList.get(getAdapterPositions).getPlanMasterID().equals("2")){

            showEditDeafaultDailog(getAdapterPositions,ivChecked,dataList.get(getAdapterPositions).isAlternate(),"Suppliment Plan");
