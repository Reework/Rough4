...
public class ColoriesAnalysisActivty extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, AdapterView.OnItemSelectedListener, View.OnClickListener {
    Context context;
    Toolbar toolbar;
    Utils utils;
...
//    NotificationService notificationService;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_colories_analysis_activty);


        context = ColoriesAnalysisActivty.this;
        ...
        ll_sleep_date = findViewById(R.id.ll_sleep_date);
...
//    }
    ...
    private void showDatePickerHistoryAddDailog() {
        ...
        datepickerdialog_history = new DatePickerDialog(ColoriesAnalysisActivty.this, android.app.AlertDialog.THEME_DEVICE_DEFAULT_LIGHT, ColoriesAnalysisActivty.this, year, month, day);
...
//                    openFitBit();
                    ...
                    if (!tempList1.isEmpty()) {
                        ...
                        Dexter.withActivity(ColoriesAnalysisActivty.this)
