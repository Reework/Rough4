...
import com.shamrock.reework.activity.mybcaplan.PlanwiseListData;
...
public class ClsSinglePathoPlanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= ClsSinglePathoPlanActivity.this;
...
//        getMyExistingBCAPlanData();
        ...
        MyBcaPlanAdapter myBcaPlanAdapter=new MyBcaPlanAdapter(ClsSinglePathoPlanActivity.this,countryList);
        ...
        call.enqueue(new Callback<ClsBcaMainClass>()
        {
            ...
            public void onResponse(Call<ClsBcaMainClass> call, retrofit2.Response<ClsBcaMainClass> response)
            {
                ...
                if (response.code() == Client.RESPONSE_CODE_OK){
                    ...
                    Toast.makeText(ClsSinglePathoPlanActivity.this, "success", Toast.LENGTH_SHORT).show();
                        ...
                        if (moodResponse!=null){
                            if (moodResponse.getCode().equals("1")){
                                ...
                                if (moodResponse.getData()!=null){
                                    Toast.makeText(ClsSinglePathoPlanActivity.this, ""+moodResponse.getData().size(), Toast.LENGTH_SHORT).show();
                                    ...
                                    BcaPlanListAdapter bcaPlanListAdapter=new BcaPlanListAdapter(ClsSinglePathoPlanActivity.this,moodResponse.getData(), 0);
...
//                new UserHealthResponse().Data=moodResponse.getData();
            ...
            {
                Toast.makeText(ClsSinglePathoPlanActivity.this, "error" +t.getMessage(), Toast.LENGTH_SHORT).show();
