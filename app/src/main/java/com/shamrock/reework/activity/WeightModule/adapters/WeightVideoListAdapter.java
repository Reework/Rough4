...
public class WeightVideoListAdapter extends RecyclerView.Adapter<WeightVideoListAdapter.MyHolder>
{
    WeightFragment context;
    ArrayList<ClsSpiritualData> list;
    OnWeightVideoListClick onHealthCatoryClick;
    int selectedPosition=-1;
    boolean isFirstTime=true;
    public WeightVideoListAdapter(WeightFragment context, ArrayList<ClsSpiritualData> list)
    {
