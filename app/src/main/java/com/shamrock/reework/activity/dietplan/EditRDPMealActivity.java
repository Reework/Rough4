...
public class
EditRDPMealActivity extends AppCompatActivity implements  TimePickerDialog.OnTimeSetListener,View.OnClickListener,MealTypeDialog.GetMealTypeListener,MealByTypeDialog.GetMealTypeListener,AddMealIntoListAdapter.OnMealRemoveListner, UOMDialog.GetUOMListener
{
    Context context;
    Toolbar toolbar;
    private Utils utils;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        context = EditRDPMealActivity.this;
        spinner_UOM=findViewById(R.id.spinner_UOM);
        spinner_UOM.setOnClickListener(this);

        obj_food_paln= (FoodPlan) getIntent().getSerializableExtra("Foodplan");
        utils = new Utils();
        TextView tvTitle=findViewById(R.id.tvTitle);
        tvTitle.setText("Edit Food Plan");
        ...
        if (obj_food_paln.getRemark()!=null){
            edt_remark_rdp.setText(obj_food_paln.getRemark());
        }
        ...
        tvQty.setText(String.valueOf(obj_food_paln.getQuantity()));
        ...
        tvMealTime.setText(obj_food_paln.getMealTime());
        ...
        if (Utils.isNetworkAvailable(context))
            if(!commingFrom.equalsIgnoreCase("Edit")) {
                getMealType();
                getFoodListByType(obj_food_paln.getMealType());
                        ...
                        if (foodUnitMasterDataArrayList!=null){
                            if (!foodUnitMasterDataArrayList.isEmpty()){
                                ...
                                for (int i = 0; i <foodUnitMasterDataArrayList.size() ; i++) {
                                    ...
                                    if (obj_food_paln.getUOM().equals(foodUnitMasterDataArrayList.get(i).getMeasurement())){
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tvMealTime:
                timepickerdialog = new TimePickerDialog(context, EditRDPMealActivity.this,
...
//            Toast.makeText(context, "Select Meal", Toast.LENGTH_SHORT).show();
                ...
                if (response.code() == Client.RESPONSE_CODE_OK)
                {
                    ...
                    if (listResponse != null && listResponse.getCode() == 1)
                    {
                        ...
                        if (data!= null && data.size() > 0)
                        {
                            ...
                            for (int i = 0; i <arrayListByMealType.size() ; i++) {
                                if (obj_food_paln.getMealName().equalsIgnoreCase(arrayListByMealType.get(i).getRecipeName()))

                                    tvMeals.setText(obj_food_paln.getMealName());
                                MealData=arrayListByMealType.get(i);
                            }
                    ...
                    if (listResponse != null && listResponse.getCode() == 1)
                    {
                        ...
                        if (arylst_mealtype_id!= null && arylst_mealtype_id.size() > 0)
                        {
                            for (int i = 0; i <arylst_mealtype_id.size() ; i++) {
                                if (obj_food_paln.getMealType().equalsIgnoreCase(arylst_mealtype_id.get(i).getMealType()))


                                    tvMealType.setText(obj_food_paln.getMealType());
                            }
...

    {
        ...
        addFoodPlanRequest.setFoodPlanId(obj_food_paln.getFoodPlanId());
                ...
                if (response.code() == Client.RESPONSE_CODE_OK)
                {
                    ...
                    if (listResponse != null && listResponse.getCode() == 1)
                    {
                        ...
                        if (data!= null && data.size() > 0)
                        {
                            ...
                            Toast.makeText(EditRDPMealActivity.this, "No records found", Toast.LENGTH_SHORT).show();
                        }
                    }
                    else
                    {
