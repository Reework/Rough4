...
public class UserFoodTripDetailsDialogFragmetNew extends BottomSheetDialogFragment  {
    ...
    UserFoodTripAdapterN UserFoodTripAdapter;


    public UserFoodTripDetailsDialogFragmetNew(UserFoodTripAdapterN addMealActivity) {
