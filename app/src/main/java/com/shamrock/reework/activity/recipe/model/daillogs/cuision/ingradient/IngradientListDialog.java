...
import com.shamrock.reework.activity.recipe.model.daillogs.cuision.CusionListAdapter;
import com.shamrock.reework.util.Utils;

import java.util.ArrayList;

public class IngradientListDialog extends DialogFragment implements View.OnClickListener, IngradientListAdapter.OnIngradientSelect
{
    Context context;
    private Utils utils;
    ...
    ArrayList<IngradientData> bundleList, languageList, languageListSearch;
    IngradientListAdapter languageAdapter;
    GetIngradientListener listener;

    private FoodUnitMasterData selectedLangaue = null;

    public IngradientListDialog() {
    }
    ...
    public void getSelectedIngradient(IngradientData cusineList) {
        listener.onSubmitIIngradientData(cusineList);
        this.dismiss();

    }

    public interface GetIngradientListener
    {
        void onSubmitIIngradientData(IngradientData model);
    }
    ...
    public void onAttach(Context context)
    {
        ...
        try
        {
            listener = (GetIngradientListener) context;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        if (getArguments() != null)
        {
            ...
            try
            {
                bundleList = (ArrayList<IngradientData>) getArguments().getSerializable("CUSION_LIST");
                if (bundleList != null)
                {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        tvTitle.setText("Select Ingradient");
        ...
        languageAdapter = new IngradientListAdapter(context, languageList, this);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener()
        {
            ...
            public boolean onQueryTextChange(String newText)
            {
                ...
                {
                    for (IngradientData model:languageListSearch)
                    {
                        if (model.getIngredientName().toLowerCase().contains(newText.toLowerCase()))
                        {
