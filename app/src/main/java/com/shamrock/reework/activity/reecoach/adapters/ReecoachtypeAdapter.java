...
public class ReecoachtypeAdapter extends RecyclerView.Adapter<ReecoachtypeAdapter.MyHolder>
{
    ...
    public ReecoachtypeAdapter(Context context, ArrayList<CheatPlanResponse.Datum> cheatPlanList, CheatPlanListener listener)
    {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
        View view = LayoutInflater.from(viewGroup.getContext()).
                inflate(R.layout.row_reecoachtype, viewGroup, false);
