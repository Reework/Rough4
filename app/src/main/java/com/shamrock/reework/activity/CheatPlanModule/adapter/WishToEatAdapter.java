...
public class WishToEatAdapter extends RecyclerView.Adapter<WishToEatAdapter.MyHolder>
        {
        Context context;
        ArrayList<WishToEatResponse.Datum> countryList;
            WishToEatListener listener;

public interface WishToEatListener
{
    public void GetWishToEatPosition(int pos, WishToEatResponse.Datum model);
}


    public WishToEatAdapter(Context context, ArrayList<WishToEatResponse.Datum> countryList, WishToEatListener listener)
    {
...
public class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener
{
    ...
    {
        listener.GetWishToEatPosition(getAdapterPosition(), countryList.get(getAdapterPosition()));
    }
}
    ...
    public void onBindViewHolder(@NonNull MyHolder myHolder, int i)
    {
        ...
        if (!TextUtils.isEmpty(countryList.get(i).getWishToEat()))
            myHolder.tvName.setText(countryList.get(i).getWishToEat());
    }
