...
public class SleepVideoListAdapter extends RecyclerView.Adapter<SleepVideoListAdapter.MyHolder>
{
    MasterSleepFragment context;
    ArrayList<ClsSpiritualData> list;
    OnSleepVideoListClick onHealthCatoryClick;
    int selectedPosition=-1;
    boolean isFirstTime=true;
    public SleepVideoListAdapter(MasterSleepFragment context, ArrayList<ClsSpiritualData> list)
    {
        this.context = context;
        this.list = list;
        onHealthCatoryClick= (OnSleepVideoListClick) context;
    }
