...
public class MindHistoryDialog extends DialogFragment implements MindMoodAdapter.MindMoodAdapterListener
{
    Context context;
    private Utils utils;
    ...
    OnSubmitMindHistoryStatus onSubmitMindHistoryStatus_listner;

    public MindHistoryDialog() {
    }

    @SuppressLint("ValidFragment")
    public MindHistoryDialog(MasterMindFragment masterMindFragment, String statusid) {
        onSubmitMindHistoryStatus_listner= (OnSubmitMindHistoryStatus) masterMindFragment;
    ...
    public void GetMoodModel(MinMoodModel model)
    {
        if (model != null)
        {
            onSubmitMindHistoryStatus_listner.getMindStatus(model,statusid);
            dismiss();
