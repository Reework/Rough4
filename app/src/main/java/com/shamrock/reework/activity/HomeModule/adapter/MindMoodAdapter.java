...
public class MindMoodAdapter extends RecyclerView.Adapter<MindMoodAdapter.MyHolder>
{
    private Context context;
    ArrayList<MinMoodModel> list;
    MindMoodAdapterListener listener;

    public interface MindMoodAdapterListener
    {
        public void GetMoodModel(MinMoodModel model);
    }

    public MindMoodAdapter(Context context, ArrayList<MinMoodModel> list, MindMoodAdapterListener listener)
    {
