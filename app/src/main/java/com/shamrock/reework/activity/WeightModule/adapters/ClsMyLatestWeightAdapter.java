...
public class ClsMyLatestWeightAdapter extends RecyclerView.Adapter<ClsMyLatestWeightAdapter.MyHolder>
{
    ...
    WeightActivitylatest weightFragment;

    public ClsMyLatestWeightAdapter(Context context, ArrayList<WeightHistory> weightHistoryArrayList, WeightActivitylatest weightFragment)
    {
    ...
    @NonNull
    @Override
    public ClsMyLatestWeightAdapter.MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
    ...
    @Override
    public void onBindViewHolder(@NonNull ClsMyLatestWeightAdapter.MyHolder holder, final int i)
    {
