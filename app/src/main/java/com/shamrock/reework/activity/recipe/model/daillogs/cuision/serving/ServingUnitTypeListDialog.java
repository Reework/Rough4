...
public class ServingUnitTypeListDialog extends DialogFragment implements View.OnClickListener, ServingUnitListAdapter.OnServingUnitSelect
{
    Context context;
    private Utils utils;
    ...
    ArrayList<ServingUnitMaster> bundleList, languageList, languageListSearch;
    ServingUnitListAdapter languageAdapter;
    GetServingUnitListener listener;

    private FoodUnitMasterData selectedLangaue = null;

    public ServingUnitTypeListDialog() {
    }
    ...
    public void getSelectedServingUnit(ServingUnitMaster cusineList) {
        ...
        listener.onSubmitServinguniteData(cusineList);
        this.dismiss();


    }

    public interface GetServingUnitListener
    {
        void onSubmitServinguniteData(ServingUnitMaster model);
    }
    ...
    public void onAttach(Context context)
    {
        ...
        try
        {
            listener = (GetServingUnitListener) context;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        if (getArguments() != null)
        {
            ...
            try
            {
                bundleList = (ArrayList<ServingUnitMaster>) getArguments().getSerializable("CUSION_LIST");
                if (bundleList != null)
                {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        tvTitle.setText("Select Serving Unit");
        ...
        languageAdapter = new ServingUnitListAdapter(context, languageList, this);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener()
        {
            ...
            public boolean onQueryTextChange(String newText)
            {
                ...
                {
                    for (ServingUnitMaster model:languageListSearch)
                    {
                        if (model.getUnit().toLowerCase().contains(newText.toLowerCase()))
                        {
