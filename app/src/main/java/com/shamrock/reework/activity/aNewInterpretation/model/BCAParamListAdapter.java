...
public class
BCAParamListAdapter extends RecyclerView.Adapter<BCAParamListAdapter.MyHolder>
{

    Context context;

    ArrayList<BCAParams> arylst_wellness_param;
    public BCAParamListAdapter(Context context, ArrayList<BCAParams> arylst_wellness_param)
    {
...
//                    .build());
    ...
    @NonNull
    @Override
    public BCAParamListAdapter.MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
    ...
    @Override
    public void onBindViewHolder(@NonNull BCAParamListAdapter.MyHolder myHolder, int i)
    {
...
//            myHolder.progressBar_wellness.setMax(100);
