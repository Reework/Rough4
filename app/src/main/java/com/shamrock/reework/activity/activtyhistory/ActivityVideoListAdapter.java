...
public class ActivityVideoListAdapter extends RecyclerView.Adapter<ActivityVideoListAdapter.MyHolder>
{
    MasterMyActivityFragment context;
    ArrayList<ClsSpiritualData> list;
    OnActivtyVideoListClick onHealthCatoryClick;
    int selectedPosition=-1;
    boolean isFirstTime=true;
    public ActivityVideoListAdapter(MasterMyActivityFragment context, ArrayList<ClsSpiritualData> list)
    {
        this.context = context;
        this.list = list;
        onHealthCatoryClick= (OnActivtyVideoListClick) context;
    }
