package com.shamrock.reework.activity.parameter.adapters;
...
public class TestNameAdapters extends BaseAdapter
{
    Context context;
    ArrayList<BCAQ> list;
    LayoutInflater inflter;

    public TestNameAdapters(Context context, ArrayList<BCAQ> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        String name = list.get(position).getTestName();
